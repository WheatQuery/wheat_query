...
<template>
    <div class="from">
        <el-form ref="form" :model="form" label-width="80px" :rules="rules" style="margin-top: 50px">
            ...
            <el-form-item label="审定意见" >
                <el-input type="textarea" v-model="form.opinion" :autosize="{ minRows: 2, maxRows: 4}"></el-input>
            </el-form-item>

            <el-form-item label="产量表现">
                <el-input type="textarea" v-model="form.yield_result"  :autosize="{ minRows: 2, maxRows: 4}"></el-input>
            </el-form-item>
            <el-form-item label="栽培技术要点" >
                <el-input type="textarea" v-model="form.tech_point"   :autosize="{ minRows: 2, maxRows: 4}"></el-input>
            </el-form-item>
